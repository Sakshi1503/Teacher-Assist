            ...
            builder.setView(v)
                    ...
                    .setPositiveButton("Enter", new DialogInterface.OnClickListener() {
                        ...
                        public void onClick(DialogInterface dialog, int id) {
                            ...
                            Cursor cursor1 = AppBase.handler.execQuery("SELECT * FROM NOTES WHERE sub = '" +
                                    subject +"';");
...
//        notificationIntent.putExtra(MainListAdapter.IS_EMERGENCY, true);
        ...
        NotificationCompat.Builder builder = new NotificationCompat.Builder(activity.getBaseContext())
                .setTicker("Teacher's Assistant").setContentTitle("Notes Are Available For this Subject")
